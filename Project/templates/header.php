    ...
    <div class="page_header">
      ...
      <div class="profile_dropdown">
        <div id="username_link">
          <a href="user_profile.php?user=<?php echo $_SESSION['username']; ?>" >
          <?php echo $_SESSION['username']; ?>
          </a>
        </div>
          <span>
            <img href="user_profile.php?user=<?echo $_SESSION['username']; ?>" src="../images/<?php echo getUserPhoto($_SESSION['username']); ?>" alt="User icon" width="20" height="20">
          </span>
