...
<div id="profile" class="flex-container">
  ...
  <div id="profile_info">
        <? if(isset($_SESSION["errormsg"]) && !empty($_SESSION["errormsg"])){ echo $_SESSION["errormsg"]; unset($_SESSION["errormsg"]);}?>
    <a href="main_page.php">Home</a> |  <a href="user_profile.php"> <? echo $_SESSION['username'] ?> 's Profile  </a>
